...
register_router.message.register(multi_register.register_submit_username, GuestStates.register_1_ask_username)
register_router.message.register(multi_register.register_submit_username, GuestStates.register_1_edit_username)
register_router.message.register(multi_register.register_submit_password, GuestStates.register_2_ask_password)
register_router.message.register(multi_register.register_submit_password, GuestStates.register_2_edit_password)
register_router.message.register(multi_register.register_submit_bank_name, GuestStates.register_3_ask_bank_name)
register_router.message.register(multi_register.register_submit_bank_name, GuestStates.register_3_edit_bank_name)
register_router.message.register(multi_register.register_submit_rekening_name, GuestStates.register_4_ask_bank_account_name)
register_router.message.register(multi_register.register_submit_rekening_name, GuestStates.register_4_edit_bank_account_name)
register_router.message.register(multi_register.register_submit_bank_account_number, GuestStates.register_5_ask_bank_account_number)
register_router.message.register(multi_register.register_submit_bank_account_number, GuestStates.register_5_edit_bank_account_number)
register_router.message.register(multi_register.register_submit_referral_code, GuestStates.register_6_ask_referral_code)
register_router.message.register(multi_register.register_submit_referral_code, GuestStates.register_6_edit_referral_code)
